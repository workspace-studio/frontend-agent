...
| `/figma-to-component` | `/figma-to-component https://figma.com/... — StatusChip` | Generate component from Figma design |
| `/sync-tokens` | `/sync-tokens https://figma.com/...` | Sync Figma design tokens to MUI theme |
| `/figma-review` | `/figma-review StatusChip https://figma.com/...` | Compare component against Figma design |
